...
export interface FeaturedCategorySectionSettings {
  ...
  displayMode?: 'grid' | 'scroll'; // grid or scroll/slider
}
...
export interface PaymentBannerSettings {
  enabled: boolean;
  imageUrl: string;
  link: string;
  title: string;
...
interface SiteSettingsContextType {
  ...
  paymentBanner: PaymentBannerSettings;
...
const defaultPaymentBanner: PaymentBannerSettings = {
  enabled: false,
  imageUrl: '',
  link: '/checkout',
...
const SiteSettingsContext = createContext<SiteSettingsContextType>({
  ...
  paymentBanner: defaultPaymentBanner,
...
export const SiteSettingsProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [paymentBanner, setPaymentBanner] = useState(defaultPaymentBanner);
