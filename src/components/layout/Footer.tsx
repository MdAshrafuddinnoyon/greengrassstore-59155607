          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h2 className="text-3xl font-serif font-bold tracking-tight">
                {isArabic ? branding.siteNameAr?.split(' ')[0] : branding.siteName?.split(' ')[0] || "GREEN"}
              </h2>
              <h2 className="text-3xl font-serif font-bold tracking-tight">
                {isArabic ? branding.siteNameAr?.split(' ')[1] : branding.siteName?.split(' ')[1] || "GRASS"}
              </h2>
            </div>
            ...
            <div className="flex items-center gap-4 mt-6">
              {footer.socialLinks.instagram && (
                <a href={footer.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
              )}
              {footer.socialLinks.facebook && (
                <a href={footer.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <Facebook className="w-5 h-5" />
                </a>
              )}
              {footer.socialLinks.whatsapp && (
                <a href={`https://wa.me/${footer.socialLinks.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
