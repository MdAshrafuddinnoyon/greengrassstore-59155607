...
<<<<<<< HEAD
  // Get footer logo - only if set, otherwise don't render
  const footerLogo = (footer.logoUrl && footer.logoUrl.trim() !== "")
    ? footer.logoUrl
...
<<<<<<< HEAD
      ...
      style={themeColors?.footerBackground ? { backgroundColor: themeColors.footerBackground } : { backgroundColor: '#3d3d35' }}
=======
      className="text-white"
...
<<<<<<< HEAD
              <div className="w-32 md:w-44 h-12 md:h-16 flex items-center justify-center">
                {footerLogo ? (
                  <img
                    key={footerLogo}
                    src={footerLogo}
                    alt={branding.siteName || 'Green Grass'}
                    className="object-contain w-full h-full max-h-12 md:max-h-16 max-w-xs mix-blend-lighten min-h-[2.5rem] aspect-[4/1]"
                    onError={(e) => {
...
<<<<<<< HEAD
                <a href={footer.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full text-gray-400 hover:text-white hover:bg-white/20 transition-colors" title="Instagram">
=======
...
<<<<<<< HEAD
                <a href={footer.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full text-gray-400 hover:text-white hover:bg-white/20 transition-colors" title="Facebook">
=======
...
<<<<<<< HEAD
                <a href={`https://wa.me/${footer.socialLinks.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full text-gray-400 hover:text-white hover:bg-white/20 transition-colors" title="WhatsApp">
=======
...
<<<<<<< HEAD
                <a href={footer.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full text-gray-400 hover:text-white hover:bg-white/20 transition-colors" title="Twitter">
=======
...
<<<<<<< HEAD
                <a href={footer.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full text-gray-400 hover:text-white hover:bg-white/20 transition-colors" title="YouTube">
=======
...
<<<<<<< HEAD
                  <li><Link to="/support" className="hover:text-white transition-colors">{isArabic ? "الدعم والمرتجعات" : "Support & Returns"}</Link></li>
=======
>>>>>>> dfcf12d2b1fa1c8d28b54c9344caef07b69c8066
