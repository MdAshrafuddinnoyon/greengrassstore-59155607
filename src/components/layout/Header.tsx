...
export const Header = () => {
  ...
  const { announcementBar, megaMenuCategories, branding, themeColors, footer, loading: settingsLoading } = useSiteSettings();
  ...
  // Get active announcements (only after settings load to avoid flash when disabled)
  const activeAnnouncements = announcementBar.announcements
    .filter(a => a.isActive)
    .sort((a, b) => a.order - b.order);
  const showAnnouncementBar = !settingsLoading && announcementBar.enabled && activeAnnouncements.length > 0;
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            {/* Logo - Center */}
            <Link to="/" className="flex flex-col items-center justify-center flex-shrink-0 mx-4 lg:mx-8 min-w-[120px]">
              <img 
