    ...
    <section className="py-10 md:py-14 bg-background border-b border-border/50" dir={isArabic ? "rtl" : "ltr"}>
      <div className="container mx-auto px-4">
        ...
        <div className="relative group">
          ...
          {/* Embla Carousel */}
          <div className="overflow-visible py-2" ref={emblaRef}>
            <div className="flex flex-nowrap gap-5 md:gap-7 px-1 md:px-2">
              {displayCategories.map((category, index) => {
                ...
                return (
                  ...
                  >
                    <Link
                      to={category.href}
                      className="group/item flex flex-col items-center gap-3 min-w-[88px] md:min-w-[96px]"
                    >
