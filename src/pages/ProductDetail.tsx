...
>>>>>>> dfcf12d2b1fa1c8d28b54c9344caef07b69c8066
  ...
  if (!product) {
<<<<<<< HEAD
    // Show the dynamic ProductNotFound page
...
<<<<<<< HEAD
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="h-14 text-base font-semibold rounded-lg border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground"
                  >
                ...
                <Button
                  ...
                  size="lg"
                  className="w-full h-14 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold text-base rounded-lg gap-2 mt-3"
                >
