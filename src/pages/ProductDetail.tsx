            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3 pt-2">
                <div className="text-center p-4 bg-muted/50 rounded-xl border border-border">
                  ...
                  <p className="text-[10px] text-muted-foreground">{isArabic ? 'فوق 200 درهم' : 'Over AED 200'}</p>
                </div>
                <div className="text-center p-4 bg-muted/50 rounded-xl border border-border">
                  ...
                  <p className="text-[10px] text-muted-foreground">{isArabic ? 'محمي 100%' : '100% Protected'}</p>
                </div>
                <div className="text-center p-4 bg-muted/50 rounded-xl border border-border">
                  ...
                  <p className="text-[10px] text-muted-foreground">{isArabic ? '14 يوم' : '14 Days'}</p>
                </div>
              </div>
            </motion.div>
          </div>
