        ...
        >
          <div className="bg-card rounded-2xl shadow-xl p-8 border border-border">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white border border-border rounded-xl py-3 px-4 font-medium text-foreground hover:bg-muted transition-colors mb-6"
            >
